...
print("Project: MultiClassAutoGLCML: Automatic Comparative Machine Learning Based on GLCM for Machine Learning Models")
...
plt.title('Prioritized Machine Learning Models based on AutoGLCML')
plt.savefig('AutoGLCML.png', dpi = 600)
plt.savefig('AutoGLCML.tif', dpi = 600)
plt.show()
plt.close()
...
df_CML.to_csv('MultiClass_AutoGLCML.csv', index = False)
print("")
